...
<div class="pop-over is-shown" data-elevation="1" :style="{left: offset.left+'px', top: offset.top+'px'}">
    <div class="no-back">
        <div class="pop-over-header js-pop-over-header"><span class="pop-over-header-title">Di chuyển thẻ</span><a href="#" class="pop-over-header-close-btn icon-sm icon-close" @click="closeMove"><i class="el-icon-close"></i></a></div>
        <div>
                ...
                <div>
                    <div>
                        <div class="pop-over-section">
                            ...
                            <input class="nch-button nch-button--primary wide js-submit" @click="move" type="submit" value="Di chuyển">
                        </div>
                    </div>
                </div>
            </div>
