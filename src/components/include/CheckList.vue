<template>
<div class="checklist">
    <div class="window-module-title"><span class="window-module-title-icon icon-lg icon-checklist"><i class="el-icon-folder-checked"></i></span>
        <div class="editable" attr="name">
            ...
            <div class="window-module-title-options" v-if="!showEditCheckList">
                <a class="nch-button confirm-delete" @click="deleteChecklist" href="#" style="margin: 0">Xóa</a>
            </div>
            <div class="edit edit-heavy" v-if="showEditCheckList">
                <textarea-autosize :value="checkListTitle" class="description-draft" placeholder="Thêm mô tả chi tiết hơn..." ref="checklistCard" id="checklistCard" :min-height="30" @keydown.enter.native="updateCheckListTitle" />
                <div class="checklist-title-edit-controls u-clearfix"><input class="nch-button nch-button--primary confirm mod-submit-edit js-save-checklist-title" type="submit" value="Lưu" @click="updateCheckListTitle">
    ...
    <div class="checklist-items-list js-checklist-items-list js-no-higher-edits ui-sortable">
        <CheckListChild v-for="(item,index) in checkList.check_list_childs" @updateCheckList="updateCheckList" @changeStatusChild="changeStatusChild" :child="item" :key="index" />
    </div>
