...
<div class="pop-over is-shown" :style="{left: offset.left+'px', top: offset.top+'px'}">
    <div class="no-back">
        <div class="pop-over-header js-pop-over-header"><span class="pop-over-header-title">Sửa Tệp đính kèm</span><a href="#" class="pop-over-header-close-btn icon-sm icon-close" @click="closeFileEdit"><i class="el-icon-close"></i></a></div>
        <div>
            <div class="pop-over-content js-pop-over-content u-fancy-scrollbar js-tab-parent">
                <div>
                    <div>
                        <form>
                            <label>Liên kết tên
                                <input class="attachment-name js-autofocus" type="text" v-model="title">
                            </label>
                            <input class="edit-attachment wide nch-button nch-button--primary" style="margin: 0;" value="Cập nhật" @click="handleEditName" type="submit">
