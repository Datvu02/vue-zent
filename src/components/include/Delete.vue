...
<div class="pop-over is-shown" data-elevation="2" :style="{left: offset.left+'px', top: offset.top+'px'}">
    <div class="no-back">
        <div class="pop-over-header js-pop-over-header"><span class="pop-over-header-title">Bạn muốn xoá?</span><a href="#" @click="closeDelete" class="pop-over-header-close-btn icon-sm icon-close"><i class="el-icon-close"></i></a>
        </div>
        <div>
            <div class="pop-over-content js-pop-over-content u-fancy-scrollbar js-tab-parent" style="max-height: 361px;">
                <div>
                    <div>
                        <p>Dữ liệu không thể khôi phục.</p><input class="btn-confirm full nch-button nch-button--danger" type="submit" @click="handleDelete" value="Xoá" data-test-id="">
                    </div>
                </div>
            </div>
        </div>
