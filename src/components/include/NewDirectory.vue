...
<div class="listWrapper">
    <div class="listContent">
        <div class="listHeader">
            <textarea class="list-header-name list-header-edit-name" id="addList" @keydown.enter="AddList" name="" placeholder="Nhập vào tiêu đề danh sách..." cols="30" rows="10" ref="title"></textarea>
        </div>
