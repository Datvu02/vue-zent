...
<div class="quick-card-editor">
    <span @click="closeCardEdit" class="icon-lg icon-close quick-card-editor-close-icon js-close-editor">
        <i class="el-icon-close"></i>
    </span>
    <div class="quick-card-editor-card" :style="{left: offset.left+'px', top: offset.top+'px', width: offset.width+'px'}">
        <div class="list-card list-card-quick-edit js-stop" style="width: 256px;">
            ...
            <div class="list-card-details js-card-details">
                <div class="list-card-labels">
                    <span class="card-label card-label-default mod-card-front" :class="[{'labelShow' :labelShow}, 'card-label-'+label.color]" v-for="(label,index) in card.labels" :key="index" :title="label.title">
                        <span class="label-text" v-if="labelShow">{{ label.name }}</span>
                    </span>
                </div>
                <textarea-autosize :value="card.title" class="list-card-edit-title" placeholder="Thêm mô tả chi tiết hơn..." id="quickEditCard" :min-height="30" @keydown.enter="updateCard" />
                <div class="badges">
                    <span class="js-badges">
                        <div class="badge js-due-date-badge mod-due-date" :class="[{'is-due-complete':isComplete},{'is-due-die': isDeadline===2},{'is-due-near': isDeadline===1}]" title="This card is complete." v-if="card.deadline!=null">
        ...
        <div class="quick-card-editor-buttons fade-in">
            ...
            <a class="quick-card-editor-buttons-item js-edit-labels" @click="showControl($event,'label')" href="#"><span class="icon-sm icon-label light"><i class="el-icon-price-tag"></i></span><span class="quick-card-editor-buttons-item-text">Chỉnh sửa nhãn</span>
            </a>
            <a class="quick-card-editor-buttons-item deadline-quick-edit"><span class="icon-sm icon-label light"><i class="el-icon-time"></i></span><span class="quick-card-editor-buttons-item-text">Chỉnh sửa thời gian</span>
                <el-date-picker type="datetime" v-model="deadLine" @change="changeDeadline">
                </el-date-picker>
            </a>
            <a class="quick-card-editor-buttons-item js-edit-labels" @click="moveCard" href="#"><span class="icon-sm icon-label light"><i class="el-icon-right"></i></span><span class="quick-card-editor-buttons-item-text">Di chuyển</span>
            </a>
            <a class="quick-card-editor-buttons-item js-edit-labels" @click="deleteCard" href="#"><span class="icon-sm icon-label light"><i class="el-icon-delete"></i></span><span class="quick-card-editor-buttons-item-text">Xóa thẻ</span>
            </a>
            <a class="quick-card-editor-buttons-item js-edit-labels" @click="closeCardEdit" href="#"><span class="icon-sm icon-label light"><i class="el-icon-close"></i></span><span class="quick-card-editor-buttons-item-text">Đóng</span>
            </a>
