...
<div class="listWrapper">
    <div class="listContent">
        <div class="listHeader">
            <textarea class="list-header-name list-header-edit-name" @keydown.enter="updateListTitle" @blur="updateListTitle" name="" id="" cols="30" rows="10" :value="listTitle" placeholder="Nhập vào tiêu đề danh sách..."></textarea>
            <div class="menu" @click="openActionList"><i class="el-icon-more"></i></div>
        </div>
        <div class="listCard">
            <draggable class="dragArea list-group" :list="item.cards" item-key="id" :animation="100" group="todo" @end="moveTodo">
                <Todo v-for="(card,index) in item.cards" @openQuickEdit="openQuickEdit" :key="index" @updateData="updateCardList" @openDetailCard="openDetailCard" :id="card.id" :card="card" />
            </draggable>
